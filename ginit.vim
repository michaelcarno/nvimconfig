...
command! -nargs=? GuiWindowMaximized call GuiWindowMaximized("<args>")
...
command! -nargs=? GuiWindowFullScreen call GuiWindowFullScreen("<args>")
...
command! -nargs=? GuiWindowFrameless call GuiWindowFrameless("<args>")
